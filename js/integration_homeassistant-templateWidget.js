...
document.addEventListener('DOMContentLoaded', () => {
  OCA.Dashboard.register('hass-template-widget', (el, {
    ...
    if (refreshInterval > 0) {
      setInterval(async () => {
        el.innerHTML = (await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].post((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateUrl)('/apps/integration_homeassistant/template'))).data[0];
